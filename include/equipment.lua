...
-- Augmented Gear
	...
	-- DEX+30, racc/ratk+20, Critical Hit Rate+10%.
	Aug.Cape.RNG.WS.Crit =  {name="Belenus's Cape", augments={'DEX+30, racc/ratk+20, Critical Hit Rate+10%',}}
	...
	-- SMN
	-- Summoning Magic Skill 1~5 BPDelay 1-3
	Aug.Cape.SMN = {name="Conveyance Cape"}
	Aug.Cape.SMN.Skill = {name="Conveyance Cape"}
	
	Aug.Cape.SMN.FC = {name="Campestres's Cape"}
	Aug.Cape.SMN.ACC = {name="Campestres's Cape"}
	Aug.Cape.SMN.Macc = {name="Campestres's Cape"}
	Aug.Cape.SMN.TP = {name="Campestres's Cape"}
	...
	-- DEX ACC STP
	Aug.Cape.BLU.TP.Aniyah = {name="Rosmerta's Cape", augments={'Accuracy+18 Attack+18','"Store TP"+10',}}
	-- STR ACC WSD
	...
	Aug.Skirmish.Acro.Body.Breath = {}
	Aug.Skirmish.Acro.Hands.Breath = {}
	Aug.Skirmish.Acro.Legs.Breath = {}
	Aug.Skirmish.Acro.Feet.Breath = {}
