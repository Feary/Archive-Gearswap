...
function buff_change(buff,gain)
	...
	elseif buff == 'Accuracy Down' and not gain then
		windower.send_command('input /p Accuracy Down Off')
	end
	...
	if buff == 'Mighty Guard' and not gain then
		windower.send_command('input /p Lost Mighty Guard')
	end
	...
	if player.main_job == "THF" then
		...
		if buff == 'Flee' and gain then
			if player.inventory["Rogue's Poulaines"] or player.wardrobe["Rogue's Poulaines"] or player.wardrobe2["Rogue's Poulaines"] or player.wardrobe3["Rogue's Poulaines"] or player.wardrobe4["Rogue's Poulaines"] then
				equip(sets.idle.PDT,{feet="Rogue's Poulaines"})
			end			
			if player.inventory["Pillager's Poulaines"] or player.wardrobe["Pillager's Poulaines"] or player.wardrobe2["Pillager's Poulaines"] or player.wardrobe3["Pillager's Poulaines"] or player.wardrobe4["Pillager's Poulaines"] then
				equip(sets.idle.PDT,{feet="Pillager's Poulaines"})
			end
			if player.inventory["Pillager's Poulaines +1"] or player.wardrobe["Pillager's Poulaines +1"] or player.wardrobe2["Pillager's Poulaines +1"] or player.wardrobe3["Pillager's Poulaines +1"] or player.wardrobe4["Pillager's Poulaines +1"] then
				equip(sets.idle.PDT,{feet="Pillager's Poulaines +1"})
			end
			if player.inventory["Pillager's Poulaines +2"] or player.wardrobe["Pillager's Poulaines +2"] or player.wardrobe2["Pillager's Poulaines +2"] or player.wardrobe3["Pillager's Poulaines +2"] or player.wardrobe4["Pillager's Poulaines +2"] then
				equip(sets.idle.PDT,{feet="Pillager's Poulaines +2"})
			end
			if player.inventory["Pillager's Poulaines +3"] or player.wardrobe["Pillager's Poulaines +3"] or player.wardrobe2["Pillager's Poulaines +3"] or player.wardrobe3["Pillager's Poulaines +3"] or player.wardrobe4["Pillager's Poulaines +3"] then
				equip(sets.idle.PDT,{feet="Pillager's Poulaines +3"})
			end
