...
if player.name == 'Derion' then
		...
		sets.idle.PDT = {main="Eminent Dagger", sub="Genbu's Shield",
				head="Espial Cap", neck="Twilight Torque", lear="Merman's Earring", rear="Merman's Earring",
                body="Espial Gambison", hands="Espial Bracers", lring=Aug.Darkring1.Derion, rring="Defending Ring",
