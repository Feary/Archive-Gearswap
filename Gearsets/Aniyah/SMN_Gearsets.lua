...
if player.name == 'Aniyah' then
		...
		-- Auto Sets
		-- Standard/idle
		sets.idle.PDT = {main={name="Patriarch Cane", priority=2}, sub={name="Genbu's Shield", priority=1},
				head="Inyanga Tiara", neck="Twilight Torque", lear="Merman's Earring", rear="Merman's Earring",
                body="Inyanga Jubbah", hands="Hagondes Cuffs", lring="Vocane Ring", rring="Defending Ring",
		...
		sets.idle.MDT = {
                ...
                body="Hagondes Coat", hands="Hagondes Cuffs", lring="Vocane Ring", rring="Shadow Ring",
		...
		sets.Resting = set_combine(sets.idle.PDT, {main="Chatoyant Staff", ammo="Clarus Stone",
                ...
                body="Hagondes Coat", hands="Serpentes Cuffs", lring="Vocane Ring", rring=Aug.Darkring1.Aniyah,
