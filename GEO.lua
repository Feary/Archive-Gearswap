...
-- Changes shadow type variable to allow cancel Copy Image if last cast was Utsusemi: Ni
	...
	if spell.type == "JobAbility" then
		...
		elseif spell.name == "Lasting Emanation" then
			...
			windower.send_command('wait 120;input /echo [%Spell.Name]/[Ecliptic Attrition]  Ready in 3 Minutes')
		...
		elseif spell.name == "Ecliptic Attraction" then
			...
			windower.send_command('wait 120;input /echo [%Spell.Name]/[Lasting Emanation]  Ready in 3 Minutes')
